...
export default function Navbar(props: any) {
    ...
    return <div className='flex-col fixed w-full z-10'>
        <div className="h-14 flex items-center w-full text-black relative shadow-2xl backdrop-blur-xl bg-white/80">
                ...
                <ul className="list-none flex space-x-5 ">
                    {
                        listHeader.map((item, index) => {
                            return <li key={index} data-to-scrollspy-id={item} className=" text-center cursor-pointer px-3 py-1 rounded-md hover:shadow-md hover:shadow-pink-600
                            duration-150
                            ">
